...
$(document).ready(function () {
  ...
  checkbox.change(function () {
    myList = checkBoxActions(this, list_Amenities);
    $('div.amenities > h4').text(myList);
  });

  checkboxStates.change(function () {
    myList = checkBoxActions(this, list_States, list_Cities);
    $('div.locations > h4').text(myList);
  });

  checkboxCities.change(function () {
    myList = checkBoxActions(this, list_Cities, list_States);
    $('div.locations > h4').text(myList);
  });
  ...
  $('.filters > button').click(function () {
    ...
    search(list_Amenities, list_States, list_Cities);
  });
